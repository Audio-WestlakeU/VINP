...
def main(input_dir:str,scp_file:str,model:str):
    ...
    time.sleep(1)
    os.system(f"CUDA_VISIBLE_DEVICES=0 eval/InASR/examples/reverb/evaluate_via_whisper_SimData.sh {input_dir} {model}")
    time.sleep(1)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-r",
        "--scp_file",
        default='eval/InASR/examples/reverb/data/et_simu_1ch/wav.scp'
    )

...
# @description: calculate normed DNSMOS.
...
def main(args):
    ...
    clips = []
    clips = glob.glob(
        os.path.join(args.testset_dir, "**", "*.wav"), recursive=True
    ) + glob.glob(os.path.join(args.testset_dir, "**", "*.flac"), recursive=True)
    ...
    if args.csv_path:
        ...
        with open(os.path.join(args.testset_dir, "_mos_normed.txt"), "w") as f:
...
if __name__ == "__main__":
    ...
    """
    usage: python eval_DNSMOS_normed.py -t [dir_path]
    """

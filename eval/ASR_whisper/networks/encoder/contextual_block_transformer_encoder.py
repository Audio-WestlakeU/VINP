...
from networks.transformer.contextual_block_encoder_layer import (
    ContextualBlockEncoderLayer,
)
from networks.transformer.embedding import StreamPositionalEncoding
...
from networks.transformer.subsampling_without_posenc import (
